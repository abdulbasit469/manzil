...
const FAQ = [
  ...
  { q: 'How many tests are there in the career assessment?', keywords: ['how many tests', 'number of tests', 'three tests'], a: 'There are 3 tests: (1) Personality Insights – MBTI type, (2) Brain Hemisphere – left/right/balanced thinking, (3) Career Path Profiler – your interests. Complete all three to see your top career fields.' },
  ...
  { q: 'What is the Brain Hemisphere test?', keywords: ['brain hemisphere', 'left brain', 'right brain', 'balanced brain'], a: 'It shows whether you lean toward left-brain (logical, analytical) or right-brain (creative) thinking, or are balanced. This is used along with other tests to refine your career field suggestions.' },
  { q: 'What is the Career Path Profiler?', keywords: ['career path profiler', 'interest test', 'interest assessment'], a: 'It is an interest-based test where you choose options that best describe you. It identifies your top interest dimensions (e.g. Analytical, Creative, Social) and links them to career fields.' },
  ...
  { q: 'When do I see my career recommendations?', keywords: ['when recommendations', 'degree recommendations', 'when do i see results', 'career recommendations'], a: 'After you complete all 3 tests (Personality, Brain Hemisphere, and Career Path Profiler), the Career fields section on the Career Assessment page shows your top career fields based on your results.' },
  { q: 'How are recommendations generated?', keywords: ['how recommendations', 'how are degrees suggested', 'algorithm'], a: 'Your career field suggestions use a transparent weighted rule-based engine: scores from all 3 tests are normalized and mapped to career fields. This keeps results consistent and explainable. The chat counselor may use AI separately to explain careers and admissions in natural language.' },
