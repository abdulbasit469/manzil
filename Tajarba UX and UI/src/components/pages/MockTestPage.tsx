              ...
              <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col w-full">
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="flex gap-3 mt-auto">
                    <Button className="flex-1 bg-gradient-to-r from-amber-500 to-amber-600 text-white hover:shadow-lg transition-all">
                      Start Test
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-3 backdrop-blur-sm sm:p-4">
          ...
          >
            ...
            <div className="shrink-0 border-t border-slate-200 bg-slate-50/90 p-3 sm:p-4 flex flex-col-reverse sm:flex-row gap-2">
              ...
              <Button className="sm:flex-1 bg-gradient-to-r from-amber-500 to-amber-600 text-white hover:shadow-lg transition-all">
                Start Practice Test
                <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
            </div>
