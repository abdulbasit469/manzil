...
import { ArrowRight, GraduationCap, Target, Users, Award, BookOpen, TrendingUp, CheckCircle, Star, Menu, X, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f1f3a] via-[#1e3a5f] to-[#2d4a6f] relative overflow-hidden">
      ...
      <section className="container mx-auto px-6 py-6 relative z-10">
        ...
        >
          ...
          >
            <div className="bg-amber-500/20 backdrop-blur-sm border border-amber-500/30 rounded-full px-6 py-2 text-amber-300 inline-flex items-center gap-2">
              <Sparkles className="w-4 h-4" />
              <span>Pakistan&rsquo;s #1 Student Success Platform</span>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-6 text-blue-200">
              <button className="hover:text-white transition-colors" onClick={() => navigate('/privacy')}>Privacy</button>
              <button className="hover:text-white transition-colors" onClick={() => navigate('/terms')}>Terms</button>
              <button className="hover:text-white transition-colors" onClick={() => navigate('/contact')}>Contact</button>
            </div>
          </div>
        </div>
      </footer>
